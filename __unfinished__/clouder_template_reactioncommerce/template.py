...
#
#             logging.info("test connect to " + baseUrl +
# ":" + port + installerUrl + " using db password " + mysql_pswd)
#
#             headers = dict()
...
#
#             mautic = requests.get(baseUrl + ":" + port +
# installerUrl + "1", headers=headers)
#             """
#             pageParser = BeautifulSoup(mautic.text, 'html.parser')
#             form =  pageParser.find_all(
# id=re.compile("install_doctrine_step_"))
#
#             arr = get_form(form)
#
...
#
#             mautic = requests.get(baseUrl + ":" + port +
# installerUrl + "2", headers=headers)
#             pageParser = BeautifulSoup(mautic.text, 'html.parser')
...
#            arr["install_user_step[password]"] = self.service_id.db_password
#             arr["install_user_step[username]"] = "admin"
#
#             logging.info("usernames will be " + self.admin_name + "
# and root pswd is " + self.service_id.db_password + " and admin email is
# " + self.admin_email)
#
#
